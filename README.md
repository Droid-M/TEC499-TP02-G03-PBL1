...
    As requisições são compostas, no total, por 4 bytes separadas em 4 instantes (cabeçalho, endereço do sensor, código do comando e rodapé, respectivamente). Cada instante é retardado em 20 milissegundos com o intuito de respeitar o tempo em que a FPGA recebe, analisa e armazena os bits.
...
Abaixo está a tabela de **comandos de requisição:**
...
### Comando de resposta: FPGA para PC
...
    Abaixo está a tabela de **comandos de resposta:**
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td><code>00000001</code> (sucesso na interpretação do comando de requisição) ou <code>00000000</code> (falha na interpretação do comando de requisição)</td>
