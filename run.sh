...
gcc input_helpers.o output_helpers.o sensor.o uart.o number_helpers.o menu.o -o menu

# Executar o executável
# ./menu ("descomente" esta linha para executar o programa automaticamente)

# Limpar os arquivos objetos e executável
# rm input_helpers.o menu.o output_helpers.o sensor.o uart.o number_helpers.o ("descomente" para permitir a reciclagem automática)
